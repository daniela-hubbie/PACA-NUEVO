...
if(!isset($_SESSION['carrito'])){    header("Location:./tienda.php");}
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p class="lead mb-5">Tu orden a sido completada con exito.</p>
            <p><a href="shop.html" class="btn btn-sm btn-primary">Regresar a Comprar</a></p>
          </div>
        </div>
      </div>
    </div>
