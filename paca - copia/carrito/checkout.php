        ...
        <div class="row mb-5">
          <div class="col-md-12">
            <div class="border p-4 rounded" role="alert">
              ¿Soy Cliente? <a href="#">Click aqui</a> para iniciar
            </div>
          </div>
        </div>
        <div class="row">
            ...
            <div class="p-3 p-lg-5 border">
              <div class="form-group">
                ...
                <select id="c_country" class="form-control">
                  <option value="1">Selecionar ciudad</option>    
              ...
              <div class="form-group row">
                <div class="col-md-12">
                  <label for="c_companyname" class="text-black">Nombre Compañia </label>
                ...
                <div class="collapse" id="ship_different_address">
                  <div class="py-2">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-6">
                        <label for="c_diff_lname" class="text-black">Appellidos<span class="text-danger">*</span></label>
          ...
          <div class="col-md-6">
            ...
            <div class="row mb-5">
              <div class="col-md-12">
                <h2 class="h3 mb-3 text-black">Codigo cupon</h2>
                <div class="p-3 p-lg-5 border">
                  ...
                  <table class="table site-block-order-table mb-5">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>$<?php echo  number_format($total,2,'.','');$arreglo[$i]['Precio'];?></td>
                      </tr>
                      <?php
                      }
